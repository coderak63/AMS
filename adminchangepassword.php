...
if(isset($_POST["changepassword"]))
{
   ...
   if($_POST["pass"]==$p)
 {
  ...
  echo '<script>if(confirm("Please Enter Correct Old Password")){location.replace("adminchangepassword.php")}</script>';
 }
}
else{
  echo '<script>if(confirm("Password Change Unsuccessful!")){location.replace("adminchangepassword.php")}</script>';
} 
...
<form name="form1" method="post" action="adminchangepassword.php" onSubmit="return check();" width="50%">
